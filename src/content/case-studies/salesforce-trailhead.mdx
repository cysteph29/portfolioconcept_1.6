...
<CaseFigure
  ...
  caption="Engagement vs. learner journey graph"
  width={1920}
  height={1080}
/>
...
<CaseFigure
  src="/work/salesforce-trailhead/case-study-trailhead-2.webp"
  alt="Research stat cards showing 11 power users interviewed across two rounds and five regions"
  caption="Stat cards: 11 power users · 2 rounds · 5 regions"
  width={1920}
  height={1080}
/>
...
<CaseFigure
  ...
  caption="Dashboard full view, trending skills, recommendations"
  width={1920}
  height={3012}
/>
...
<CaseFigure
  src="/work/salesforce-trailhead/case-study-trailhead-6.webp"
  alt="Diagram showing where Trailhead Solve and the Personalised Dashboard fit into the power user engagement loop"
  caption="Where this solution fits in"
  width={1920}
  height={1080}
/>
...
<CaseFigure
  src="/work/salesforce-trailhead/case-study-trailhead-3.webp"
  alt="User testing stat cards comparing Solve to ChatGPT, confidence in answers, dashboard insights, and return intent"
  caption="Stat cards: 6/8 would use Solve over ChatGPT for Salesforce-specific questions · 4.5/5 average confidence in Solve's answers · 5/8 said the Dashboard surfaced insights they wouldn't have explored on their own · 6/8 expressed unprompted intent to return after the session"
  width={1920}
  height={1080}
/>
